...
pub struct LetsStartForm {
    ...
    pub min_budget: u32,
    #[validate(range(min = 1_000, max = 50_000, message = "The budget must range from 1,000 to 50,000 USD"))]
    pub max_budget: u32,

    #[validate(length(min = 2, max = 32, message = "The name must be between 2 and 32 chars"))]
    pub name: String,

    #[validate(length(min = 64, max = 512, message = "The project description must be between 64 and 512 chars"))]
